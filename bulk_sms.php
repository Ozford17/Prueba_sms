				...
				<div class="form-group">
					...
					<table width="100%" id="bulksmstable">
						...
						<tr>
							...
							<td>
							<?php
								echo '<select name="from_number" id="twilio_numbers" class="form-control" onchange="listMobileDevices(this)" >';
						...
						<tr id="listOfMobileDevices" class="display-1">
						...
						<tr class="daterange display-none">
							<td aling="left"><label>Date range</label></td>
							<td>
						...
						<tr class="daterange display-none">
							<td aling="left"><label>Select Group</label></td>
							<td>
