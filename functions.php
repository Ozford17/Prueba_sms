<?php
				...
				if(mysqli_num_rows($resCheck)){
					...
					if($rowCheck['status']=='1') {
						if ($from == 'mobile_sim') {
							...
							else if($settings['sms_gateway']=='signalwire'){
								if(trim($media)!=''){
									$data = array(
										"From" => $from,
										"To" => $to,
							...
							}else if($settings['sms_gateway']=='telnyx'){
								$apiKey = "KEY016F31E28141726D206616E73409B104_EW1hak52eYLINEswmuw2va";
	...
	function getTimeArray(){
		$timeArray = array('00:00:00'=>'12:00 AM',
		'00:15:00'=>'12:15 AM',
		'00:30:00'=>'12:30 AM',
		'00:45:00'=>'12:45 AM',
		'01:00:00'=>'01:00 AM',
