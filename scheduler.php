					...
					<div class="card">
						...
						<div class="content table-responsive">
							...
							<div class="form-group">
								...
								<select class="form-control" name="group_id" onChange="getGroupNumbers(this.value)" parsley-trigger="change" <?php if(isset($_REQUEST['custom']) && $_REQUEST['custom']!=1){?> required <?php } ?>>
								...
								<?php
									...
									if(mysqli_num_rows($resg)){
										while($rowg = mysqli_fetch_assoc($resg)){
											if(isset($_REQUEST['group_id']) &&$_REQUEST['group_id']==$rowg['id']){ $sel = "selected"; }else{ $sel = ""; }
                                            ?>
							...
							<div class="form-group">
                                ...
                                if(isset($_REQUEST['custom']) && $_REQUEST['custom']==1){
                                    $where = "";
                                    
                                    if(isset($_REQUEST['all_numbers']) && $_REQUEST['all_numbers']==1){
                                        $where .= " and s.phone_number like '%".$_REQUEST['search']."%'";
                                    }else                                    
                                    if(isset($_REQUEST['checked_numbers']) && $_REQUEST['checked_numbers']!=""){
