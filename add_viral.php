<?php
    ...
    $row = $row['share_with_subaccounts'];
                                        ...
                                        <div class="panel-collapse sms_texts_section display-block" aria-expanded="true">
                                            <div class="portlet-body padding-10">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="code_message" parsley-trigger="change" required placeholder="Enter sms text to share unique code with friends to make their own chain" class="form-control textCounter"><?php echo DBout(!empty($row['code_message']) ? $row['code_message'] : '')?></textarea>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="notification_msg" parsley-trigger="change" required placeholder="Enter sms text that will notify user when some subscribe using his code" class="form-control textCounter"><?php echo DBout(!empty($row['notification_msg']) ? $row['notification_msg']: '')?></textarea>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="winner_msg" parsley-trigger="change" required placeholder="Enter sms text that will inform user that his firend/followers sent his code required time and he won" class="form-control textCounter"><?php echo DBout(!empty($row['winner_msg']) ? $row['winner_msg'] : '')?></textarea>
                                                    <span class="showCounter">
                                                    <span class="showCount"></span> Characters left
                                                </span>
                                                </div>
